...
const GradientLineRecorrer = () => {
  ...
  const [crosshairPos, setCrosshairPos] = useState(lastCoordinate)
  const [pointCamera, setPointCamera] = useState(firstPoint)
  ...
  const getGps = () => {
    ...
    Geolocation.watchPosition(
      position => {
        ...
        console.log('=> entro')
        // setPointCamera(point)
        // setS([...s, point]) // Fix: Update the 's' state correctly
        const newCords = [...coordinates, [...point]]
