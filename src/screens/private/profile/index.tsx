        ...
        {showInfo && (
          <>
            ...
            <TouchableOpacity
              ...
              <Text>Crear Wallet</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.card}
              onPress={() => {
                found
                console.log('Founding Wallet', found)
              }}>
              <Text>fondear Wallet</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.card}
              onPress={() => {
                write
                console.log('write in blockchain', write)
              }}>
              <Text>Escribir en blockchain</Text>
            </TouchableOpacity>
          </>
        )}
      </View>
